...
# 请确保返回的数据格式为：{股票名称1:股票代码1:股票1主营业务简介}、{股票名称2:股票代码2:股票2主营业务简介}...。例如：{大富科技:300134:国内领先的移动通信设备......}、{宜安科技:300328:公司在新能源汽车、液态金属新材料行业.....}。请确保每个公司的信息都按照这种格式返回，并且不要添加任何额外的内容或注释。
# """
# information =a.get_evaluation(content)
# print(information)
# information='''
# {东睦股份:300892:主营业务为粉末冶金材料制造及销售}
# {日久光电:603895:主营业务为柔性光学导电材料生产及销售}
# {斯迪克:603228:主营业务为为折叠屏终端客户提供解决方案}
# {宜安科技:300328:主营业务为新能源汽车、液态金属新材料行业}
# {精研科技:300709:主营业务为智能硬件产品的研发、生产和销售}
# {大富科技:300134:主营业务为移动通信设备的研发、生产和销售}
# {科森科技:002518:主营业务为汽车零部件的研发、生产和销售}
# '''
# information=a.get_evaluation(content)
# con=a.extract_company_info(information)
#
# print(con)
